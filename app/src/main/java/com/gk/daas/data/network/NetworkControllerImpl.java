...
public class NetworkControllerImpl implements NetworkController {
    ...
    public NetworkControllerImpl(OpenWeatherService weatherService, LogFactory logFactory, Bus bus, Toaster toaster, NetworkConnectionChecker connectionChecker, DataStore dataStore, TaskCounter taskCounter, ErrorInterpreter errorInterpreter) {
    ...
    @Override
    public void getTemp_OfflineLocalStore(String city) {
